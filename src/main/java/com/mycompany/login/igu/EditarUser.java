...
public class EditarUser extends javax.swing.JFrame {
    ...
    public EditarUser(Controladora controladora,int id) {
        initComponents();
        this.id = id;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        controladora.editarUsuario(user,usuario,contrasenia,rol);
        
        JOptionPane optionPane = new JOptionPane("Usuario editado correctamente");
    ...
    private void cargarDatos() {
        user = controladora.encontrarUser(id);
