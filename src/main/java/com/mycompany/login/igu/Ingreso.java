...
public class Ingreso extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        Usuario user = controladora.validarUsuario(usuario,contrasenia);
        if(user != null){
            String rol = user.getRol().getNombreRol();
            if(rol.equals("admin")){
                PrincipalAdmin pAdmin = new PrincipalAdmin(controladora,user);
                pAdmin.setVisible(true);
                pAdmin.setLocationRelativeTo(null);
                this.dispose();
            }
            if(rol.equals("user")){
                PrincipalUser pUser = new PrincipalUser(controladora,user);
